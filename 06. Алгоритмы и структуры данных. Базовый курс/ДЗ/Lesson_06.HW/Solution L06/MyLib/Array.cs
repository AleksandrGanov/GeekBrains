...
namespace mlArray
{
    ...
    public static class ArrSorting
    {
        public static void Swap(int a, int b, ref int[] arr, bool print = false)
        {
            int c = arr[a];
            arr[a] = arr[b];
            arr[b] = c;
    ...
    {
        public static int FindMinimal(ref int[] arr, out int minValueIndex)
        {
            int minValue = arr[0]; minValueIndex = 0;
