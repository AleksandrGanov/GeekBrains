...
namespace Lesson07.HW.Task02
{
    class Program
    {
        ...
        /// <summary>
        /// Метод организует проход через граф волны "в ширину"
        /// </summary>
        ...
        private static void WaveInWidth(int[,] arr, int vertexStart = 1)
        {
            ...
            void RecursiveSearch(int vertexStartSrch)
            {
                ...
                while (front.Count != 0) { RecursiveSearch((int)front.Dequeue()); }
